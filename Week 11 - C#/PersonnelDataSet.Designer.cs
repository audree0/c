...
namespace Week11_CS_PersonnelDatabase {
    ...
    public partial class PersonnelDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string Name, string Position, decimal Hourly_Wage) {
            ...
            private void InitClass() {
                ...
                this.columnHourly_Wage = new global::System.Data.DataColumn("Hourly Wage", typeof(decimal), null, global::System.Data.MappingType.Element);
                ...
                this.columnHourly_Wage.AllowDBNull = false;
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public decimal Hourly_Wage {
                get {
                    return ((decimal)(this[this.tableTable.Hourly_WageColumn]));
                }
                set {
                    this[this.tableTable.Hourly_WageColumn] = value;
                }
            }
        }
...
namespace Week11_CS_PersonnelDatabase.PersonnelDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Position] = @Original_Position) AND ([Hourly Wage] = @Original_Hourly_" +
                "Wage))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Hourly_Wage", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Wage", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Name], [Position], [Hourly Wage]) VALUES (@Id, " +
                "@Name, @Position, @Hourly_Wage);\r\nSELECT Id, Name, Position, [Hourly Wage] FROM " +
                "[Table] WHERE (Id = @Id)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Hourly_Wage", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Wage", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Position] = @Position, [Hourly Wage] = @Hourly_Wage WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Position] = @Original_Position) AND ([Hourly Wage] = @Original_Hourly_Wage));
SELECT Id, Name, Position, [Hourly Wage] FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Hourly_Wage", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Wage", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Hourly_Wage", global::System.Data.SqlDbType.Money, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Hourly Wage", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Week11_CS_PersonnelDatabase.Properties.Settings.Default.PersonnelConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Position, [Hourly Wage] FROM dbo.[Table]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Name, Position, [Hourly Wage] FROM dbo.[Table] order by [Hourly Wage] " +
                "desc";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Id, Name, Position, [Hourly Wage] FROM dbo.[Table] order by [Hourly Wage]";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "SELECT Id, Name, Position, [Hourly Wage] FROM dbo.[Table] where name like\'% + @se" +
                "archedName + %\'";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "SELECT Max([Hourly Wage]) FROM [Table]";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[5] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[5].Connection = this.Connection;
            this._commandCollection[5].CommandText = "SELECT Min([Hourly Wage]) FROM [Table]";
        ...
        public virtual int FillByHourlyPayD(PersonnelDataSet.TableDataTable dataTable) {
        ...
        public virtual PersonnelDataSet.TableDataTable GetDataBy1() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            PersonnelDataSet.TableDataTable dataTable = new PersonnelDataSet.TableDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByHourlyWageA(PersonnelDataSet.TableDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual PersonnelDataSet.TableDataTable GetDataBy() {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            PersonnelDataSet.TableDataTable dataTable = new PersonnelDataSet.TableDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByNameResult(PersonnelDataSet.TableDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual PersonnelDataSet.TableDataTable GetDataBy2() {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            PersonnelDataSet.TableDataTable dataTable = new PersonnelDataSet.TableDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Position, decimal Original_Hourly_Wage) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((decimal)(Original_Hourly_Wage));
        ...
        public virtual int Insert(int Id, string Name, string Position, decimal Hourly_Wage) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((decimal)(Hourly_Wage));
        ...
        public virtual int Update(int Id, string Name, string Position, decimal Hourly_Wage, int Original_Id, string Original_Name, string Original_Position, decimal Original_Hourly_Wage) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((decimal)(Hourly_Wage));
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((decimal)(Original_Hourly_Wage));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Position, decimal Hourly_Wage, int Original_Id, string Original_Name, string Original_Position, decimal Original_Hourly_Wage) {
            return this.Update(Original_Id, Name, Position, Hourly_Wage, Original_Id, Original_Name, Original_Position, Original_Hourly_Wage);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<decimal> SearchHighestPay() {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<decimal> SearchLowestPay() {
